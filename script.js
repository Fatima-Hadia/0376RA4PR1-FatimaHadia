...
console.log(text-classe);
console.log(boto-toggle);

//6 - Esdeveniments: Afegeix un addEventListener a un botó perquè tregui una alerta (alert).

let alerta = document.querySelector("#boto-alerta");

alerta.addEventListener("click", function(){
    alert("Hola!");
});
console.log(boto-alerta);
